...
class Expense {
  ...
  factory Expense.fromJson(Map<String, dynamic> json) {
    return Expense(
      ...
      category: ExpenseCategory.values.byName(json['category'] as String? ?? 'MATERIAL'),
      description: json['description'] as String,
      amount: (json['amount'] as num).toDouble(),
      billNo: json['billNo'] as String?,
      billDate: json['billDate'] != null ? DateTime.parse(json['billDate']) : null,
      paidTo: json['paidTo'] as String?,
      paymentMethod: PaymentMethod.values.byName(json['paymentMethod'] as String? ?? 'CASH'),
  ...
  @override
  String toString() => 'Expense(id: $id, expenseNo: $expenseNo, amount: $amount)';
}
...
class Invoice {
  ...
  factory Invoice.fromJson(Map<String, dynamic> json) {
    return Invoice(
      ...
      status: InvoiceStatus.values.byName(json['status'] as String? ?? 'DRAFT'),
      ...
      paidAmount: json['paidAmount'] != null ? (json['paidAmount'] as num).toDouble() : 0,
  ...
  @override
  String toString() => 'Invoice(id: $id, invoiceNo: $invoiceNo, status: ${status.name})';
}
...
class InvoiceItem {
  ...
  @override
  String toString() => 'InvoiceItem(id: $id, description: $description)';
}
...
class Payment {
  ...
  factory Payment.fromJson(Map<String, dynamic> json) {
    return Payment(
      ...
      receivedBy: json['receivedBy'] != null ? User.fromJson(json['receivedBy']) : null,
      notes: json['notes'] as String?,
      createdAt: DateTime.parse(json['createdAt']),
      createdById: json['createdById'] as String?,
      createdBy: json['createdBy'] != null ? User.fromJson(json['createdBy']) : null,
  ...
  @override
  String toString() => 'Payment(id: $id, paymentNo: $paymentNo, amount: $amount)';
}
