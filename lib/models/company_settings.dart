...
class Company {
  ...
  factory Company.fromJson(Map<String, dynamic> json) {
    return Company(
      ...
      officeLatitude: json['officeLatitude'] != null ? (json['officeLatitude'] as num).toDouble() : null,
      officeLongitude: json['officeLongitude'] != null ? (json['officeLongitude'] as num).toDouble() : null,
      officeGeofence: json['officeGeofence'] != null ? (json['officeGeofence'] as num).toDouble() : 100,
      ...
      settings: json['settings'] != null ? CompanySettings.fromJson(json['settings']) : null,
    );
  }
...
class CompanySettings {
  ...
  factory CompanySettings.fromJson(Map<String, dynamic> json) {
    return CompanySettings(
      ...
      workingHours: json['workingHours'] != null ? (json['workingHours'] as num).toDouble() : 8,
      overtimeRate: json['overtimeRate'] != null ? (json['overtimeRate'] as num).toDouble() : 1.5,
  ...
  @override
  String toString() => 'CompanySettings(companyId: $companyId, currency: $currency)';
}
