...
import 'package:construction_erp/core/services/app_colors.dart'; // Assuming this exists from previous context
        ...
        child: Column(
          children: [
            ...
            _buildInfoCard(
              title: "Account Info",
              children: [
                _buildInfoRow("User type", "SUPER_ADMIN", isValueBold: true),
                _buildInfoRow(
                    "Account created",
                    user.createdAt == null
                        ? "N/A"
